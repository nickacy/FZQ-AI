...
schema_init = Path(r'C:\Users\nicka\FZQ-AI-WORKSPACE\FZQ-AI\fzq_ai\schemas\test_adapter\__init__.py')
old_content = schema_init.read_text(encoding='utf-8')
...
from fzq_ai.schemas.test_adapter import MultiDimensionAnalysis, PipelineInput, RawNewsItem, NewsSource, LanguageCode, RegionCode
print('Schema OK')
...
schema_init.write_text(old_content, encoding='utf-8')
